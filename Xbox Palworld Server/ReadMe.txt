...
**Usage:**
Just double-click `start_server_xbox.cmd`, and it'll handle the rest.  
To close the script and server at the same time, double-click the same `start_server_xbox.cmd` file again, and it'll shut down both.
