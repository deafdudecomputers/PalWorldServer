...
server_name = "Xbox" #Edit this for your server "folder name".
...
discord_webhook_url = "" #Edit this for your discord webhook.
...
server_reboot_enabled = 1 #Set to 1 if you want server to reboot at certain hours, otherwise set to 0 if you don't want it to reboot.
server_reboot_hours = 4 #Set to certain hours server will reboot on.
def get_public_ip():
...
def update_palworldsettings_file(config_file, server_restapi_port, server_rcon_port, server_port, admin_password, config_server_name, config_server_desc, server_password, public_ip):
    ...
    replacements = {
        ...
        'AllowConnectPlatform=[a-zA-Z]+': 'AllowConnectPlatform=Xbox', #Do NOT touch this, leave as is.
