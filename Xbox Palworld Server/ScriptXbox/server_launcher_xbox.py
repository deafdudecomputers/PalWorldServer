...
def setup_server():
    ...
    if is_process_running(palserver_exe, os.path.dirname(palserver_exe)):
        ...
        extract_steamcmd()
        update_server()
        #update_server_manifest("6456498670363316145") #As of 10/30/2024, this is the latest Xbox version accessible to current clients. https://steamdb.info/depot/2394011/manifests/
